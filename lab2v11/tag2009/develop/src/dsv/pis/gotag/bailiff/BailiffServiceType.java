...
/**
 * This class subclasses one of the Jini utility classes, intended to make life
 * slightly easier for services.
 */
public class BailiffServiceType extends ServiceType {
	 ...
	 * 
	 * @param iconKind
	 *            The kind of icon requested. @see java.beans.BeanInfo
		...
		case BeanInfo.ICON_COLOR_32x32:
			if (color32x32 == null) {
				URL u = getClass().getResource(
						"/se/su/dsv/fk/bailiff/Bailiff32x32.gif");
				if (u != null) {
