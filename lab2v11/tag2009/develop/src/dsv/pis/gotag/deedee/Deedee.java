...
public class Deedee implements Serializable {
	...
	/**
	 * The service discovery manager helps us locating Jini lookup servers and
	 * to query them for the services they contain.
	 */
	...
	public static void main(String[] argv) throws java.io.IOException,
		...
		Deedee de = new Deedee("ralph", "This is a message for Ralph!", 300000);
		de.topLevel();
		System.exit(0);
	}
}
